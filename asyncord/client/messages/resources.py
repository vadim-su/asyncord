...
class MessageResource(ClientSubresource):
    ...
    def __init__(self, parent: ClientResource, channel_id: LikeSnowflake) -> None:
    ...
    async def update(self, message_id: LikeSnowflake, message_data: UpdateMessageRequest) -> MessageResponse:
        """Update a message.

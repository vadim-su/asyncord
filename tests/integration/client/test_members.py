...
async def test_list_members(members_res: MemberResource):
...
async def test_update_current_member(members_res: MemberResource):
...
async def test_kick(members_res: MemberResource):
